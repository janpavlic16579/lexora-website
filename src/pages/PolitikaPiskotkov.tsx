          ...
          <div className="space-y-8 text-base leading-relaxed">
            <section>
              ...
              <ul className="list-none space-y-2 text-blue-400">
                <li className="flex justify-between"><a href="#povzetek" className="hover:underline">1. Kratek povzetek v preprostem jeziku</a><span className="text-neutral-500">1</span></li>
                <li className="flex justify-between"><a href="#upravljavec" className="hover:underline">2. Upravljavec in kontakt</a><span className="text-neutral-500">2</span></li>
                <li className="flex justify-between"><a href="#kaj-so" className="hover:underline">3. Kaj so piškotki in podobne tehnologije</a><span className="text-neutral-500">2</span></li>
                <li className="flex justify-between"><a href="#katere-vrste" className="hover:underline">4. Katere vrste piškotkov/identifikatorjev uporabljamo</a><span className="text-neutral-500">2</span></li>
                <li className="flex justify-between"><a href="#kako-upravljate" className="hover:underline">5. Kako upravljate privolitve</a><span className="text-neutral-500">3</span></li>
                <li className="flex justify-between"><a href="#kateri-se-uporabljajo" className="hover:underline">6. Kateri piškotki/identifikatorji se uporabljajo</a><span className="text-neutral-500">4</span></li>
                <li className="flex justify-between"><a href="#tretje-osebe" className="hover:underline">7. Tretje osebe in prejemniki</a><span className="text-neutral-500">4</span></li>
                <li className="flex justify-between"><a href="#prenosi" className="hover:underline">8. Prenosi izven EGP</a><span className="text-neutral-500">4</span></li>
                <li className="flex justify-between"><a href="#kako-dolgo" className="hover:underline">9. Kako dolgo trajajo piškotki/identifikatorji</a><span className="text-neutral-500">4</span></li>
                <li className="flex justify-between"><a href="#spremembe" className="hover:underline">10. Spremembe politike</a><span className="text-neutral-500">4</span></li>
                <li className="flex justify-between"><a href="#evidenca" className="hover:underline">11. Evidenca piškotkov in identifikatorjev</a><span className="text-neutral-500">4</span></li>
                <li className="flex justify-between"><a href="#tehnicna-izvedba" className="hover:underline">12. Tehnična izvedba pasice in evidence privolitev</a><span className="text-neutral-500">6</span></li>
                <li className="flex justify-between pl-4"><a href="#kljucne-zahteve" className="hover:underline">12.1 Ključne zahteve za banner in nastavitve</a><span className="text-neutral-500">6</span></li>
                <li className="flex justify-between pl-4"><a href="#primer-besedila" className="hover:underline">12.2 Primer besedila pasice</a><span className="text-neutral-500">6</span></li>
                <li className="flex justify-between pl-4"><a href="#blokiranje-skript" className="hover:underline">12.3 Blokiranje skript pred privolitvijo</a><span className="text-neutral-500">7</span></li>
                <li className="flex justify-between pl-4"><a href="#evidenca-privolitev" className="hover:underline">12.4 Evidenca privolitev (consent records) in izvoz</a><span className="text-neutral-500">7</span></li>
                <li className="flex justify-between"><a href="#mermaid-diagram" className="hover:underline">13. Mermaid diagram toka privolitve</a><span className="text-neutral-500">8</span></li>
                <li className="flex justify-between"><a href="#pravna-utemeljitev" className="hover:underline">14. Pravna utemeljitev</a><span className="text-neutral-500">9</span></li>
                <li className="flex justify-between pl-4"><a href="#kaj-zahteva" className="hover:underline">14.1 Kaj zahteva ePrivacy in ZEKom‑2</a><span className="text-neutral-500">9</span></li>
                <li className="flex justify-between pl-4"><a href="#kateri-identifikatorji" className="hover:underline">14.2 Kateri identifikatorji običajno zahtevajo privolitev</a><span className="text-neutral-500">9</span></li>
                <li className="flex justify-between pl-4"><a href="#kako-se-poveze" className="hover:underline">14.3 Kako se to poveže z GDPR</a><span className="text-neutral-500">9</span></li>
                <li className="flex justify-between"><a href="#kakovost-privolitve" className="hover:underline">15. Kakovost privolitve in “dark patterns” (kaj se izogibati)</a><span className="text-neutral-500">10</span></li>
              </ul>
            </section>

            <section id="povzetek">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">1. Kratek povzetek v preprostem jeziku</h2>
            ...
            <section id="upravljavec">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">2. Upravljavec in kontakt</h2>
            ...
            <section id="kaj-so">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">3. Kaj so piškotki in podobne tehnologije</h2>
            ...
            <section id="katere-vrste">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">4. Katere vrste piškotkov/identifikatorjev uporabljamo</h2>
            ...
            <section id="kako-upravljate">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">5. Kako upravljate privolitve</h2>
            ...
            <section id="kateri-se-uporabljajo">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">6. Kateri piškotki/identifikatorji se uporabljajo</h2>
            ...
            <section id="tretje-osebe">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">7. Tretje osebe in prejemniki</h2>
            ...
            <section id="prenosi">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">8. Prenosi izven EGP</h2>
            ...
            <section id="kako-dolgo">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">9. Kako dolgo trajajo piškotki/identifikatorji</h2>
            ...
            <section id="spremembe">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">10. Spremembe politike</h2>
            ...
            <section id="evidenca">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">11. Evidenca piškotkov in identifikatorjev</h2>
            ...
            <section id="tehnicna-izvedba">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">12. Tehnična izvedba pasice in evidence privolitev</h2>
              ...
              <h3 id="kljucne-zahteve" className="text-lg font-bold text-white mt-6 mb-2">12.1 Ključne zahteve za banner in nastavitve</h3>
              ...
              <h3 id="primer-besedila" className="text-lg font-bold text-white mt-6 mb-2">12.2 Primer besedila pasice</h3>
              ...
              <h3 id="blokiranje-skript" className="text-lg font-bold text-white mt-6 mb-2">12.3 Blokiranje skript pred privolitvijo</h3>
              ...
              <h3 id="evidenca-privolitev" className="text-lg font-bold text-white mt-6 mb-2">12.4 Evidenca privolitev (consent records) in izvoz</h3>
            ...
            <section id="mermaid-diagram">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">13. Mermaid diagram toka privolitve</h2>
            </section>

            <section id="pravna-utemeljitev">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">14. Pravna utemeljitev</h2>
              
              <h3 id="kaj-zahteva" className="text-lg font-bold text-white mt-6 mb-2">14.1 Kaj zahteva ePrivacy in ZEKom‑2</h3>
              ...
              <h3 id="kateri-identifikatorji" className="text-lg font-bold text-white mt-6 mb-2">14.2 Kateri identifikatorji običajno zahtevajo privolitev</h3>
              ...
              <h3 id="kako-se-poveze" className="text-lg font-bold text-white mt-6 mb-2">14.3 Kako se to poveže z GDPR</h3>
            ...
            <section id="kakovost-privolitve">
              <h2 className="text-2xl font-serif text-white mt-12 mb-4">15. Kakovost privolitve in “dark patterns” (kaj se izogibati)</h2>
